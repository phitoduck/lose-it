...
def log(
    ...
    # Mutual-exclusion + presence validation. Errors here exit 2 (usage),
    # matching how other invalid-flag-combo errors in this CLI behave.
